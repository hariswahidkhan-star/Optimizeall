"""Declarative base and the column set every business row carries.

Phase 4 conventions: org_id on every business row (row-level security is meaningless
without it), timestamptz throughout, and an optimistic-concurrency version surfaced
to clients as an ETag.
"""
